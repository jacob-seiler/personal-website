<template>
    <main class="container text-center">
        ...
        <SocialAnchors />
        <p class="mt-40 text-md tiny:text-sm mx-24 dark:text-white">
        ...
        <div class="p-end">
            ...
            <button class="text-green underline cursor-pointer text-md tiny:text-sm font-bold" @click="scrollToTop">
                Back to top
            </button>
        </div>
    </main>
